...
import { NotificationSendSuccesssComponent } from './notification-send-successs/notification-send-successs.component';
...
const routes: Routes = [
  ...
  {
    path: 'authentication/form-request',
    component: FormRequestComponent
  },
  {
    path: 'authentication/send-infomation-success',
    component: NotificationSendSuccesssComponent
  }
];
...
@NgModule({
  declarations: [
    ...
    NotificationSendSuccesssComponent
  ],
